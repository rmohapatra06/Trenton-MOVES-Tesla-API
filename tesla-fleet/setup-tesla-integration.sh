...
echo "4️⃣  Generated OAuth URL (Third-Party/ownerapi):"
RANDOM_STATE=$(openssl rand -hex 16)
OAUTH_URL="https://fleet-auth.prd.vn.cloud.tesla.com/oauth2/v3/authorize?&client_id=${CLIENT_ID}&locale=en-US&prompt=login&redirect_uri=https://${NGROK_DOMAIN}/extractToken&response_type=code&scope=openid%20vehicle_device_data%20offline_access&state=${RANDOM_STATE}"
echo "   $OAUTH_URL"
echo ""
